...
V1 PRDs are drafted under `docs/features/v1/` and linked from their roadmap items below.
...
- Current repository state: documentation-only project; no Rust crate exists yet.
...
- **PRD candidate:** Yes. PRD: [`docs/features/v1/prd-001-rust-project-foundation.md`](features/v1/prd-001-rust-project-foundation.md)
...
- **PRD candidate:** Yes. PRD: [`docs/features/v1/prd-002-configuration-and-agent-definitions.md`](features/v1/prd-002-configuration-and-agent-definitions.md)
- **Dependencies:** 001.
...
- **PRD candidate:** Yes. PRD: [`docs/features/v1/prd-003-skill-source-scanning.md`](features/v1/prd-003-skill-source-scanning.md)
...
- **PRD candidate:** Yes. PRD: [`docs/features/v1/prd-004-inventory-and-exposure-resolution.md`](features/v1/prd-004-inventory-and-exposure-resolution.md)
...
- **PRD candidate:** Yes. PRD: [`docs/features/v1/prd-005-human-readable-cli-workflow.md`](features/v1/prd-005-human-readable-cli-workflow.md)
...
- **PRD candidate:** Yes. PRD: [`docs/features/v1/prd-006-safe-import-and-removal-plans.md`](features/v1/prd-006-safe-import-and-removal-plans.md)
- **Dependencies:** 004.
...
- **PRD candidate:** Yes. PRD: [`docs/features/v1/prd-007-assistant-style-tui-shell.md`](features/v1/prd-007-assistant-style-tui-shell.md)
...
- **PRD candidate:** Yes. Suggested file: `docs/prd/008-arbitrary-project-targeting.md`
...
- **PRD candidate:** Yes. Suggested file: `docs/prd/009-git-url-import-into-managed-source-directory.md`
...
- **PRD candidate:** Yes. Suggested file: `docs/prd/010-manual-install-migration.md`
...
- **PRD candidate:** Yes. Suggested file: `docs/prd/011-stronger-tui-exposure-editing.md`
...
- **PRD candidate:** Later. Suggested file: `docs/prd/012-context-budget-visibility.md`
...
- **PRD candidate:** Later. Suggested file: `docs/prd/013-shareable-setup-profiles.md`
...
- **PRD candidate:** Later. Suggested file: `docs/prd/014-repository-health-and-update-awareness.md`
- **Dependencies:** 009.
...
|---|---|---|---|---|---|---|
| 001 | Rust project foundation | V1 | [`docs/features/v1/prd-001-rust-project-foundation.md`](features/v1/prd-001-rust-project-foundation.md) | High | Drafted | None |
| 002 | Configuration and agent definitions | V1 | [`docs/features/v1/prd-002-configuration-and-agent-definitions.md`](features/v1/prd-002-configuration-and-agent-definitions.md) | High | Drafted | 001 |
| 003 | Skill source scanning | V1 | [`docs/features/v1/prd-003-skill-source-scanning.md`](features/v1/prd-003-skill-source-scanning.md) | High | Drafted | 001, 002 |
| 004 | Inventory and exposure resolution | V1 | [`docs/features/v1/prd-004-inventory-and-exposure-resolution.md`](features/v1/prd-004-inventory-and-exposure-resolution.md) | High | Drafted | 002, 003 |
| 005 | Human-readable CLI workflow | V1 | [`docs/features/v1/prd-005-human-readable-cli-workflow.md`](features/v1/prd-005-human-readable-cli-workflow.md) | Medium | Drafted | 002, 003, 004, 006 for mutations |
| 006 | Safe import and removal plans | V1 | [`docs/features/v1/prd-006-safe-import-and-removal-plans.md`](features/v1/prd-006-safe-import-and-removal-plans.md) | High | Drafted | 004 |
| 007 | Assistant-style TUI shell | V1 | [`docs/features/v1/prd-007-assistant-style-tui-shell.md`](features/v1/prd-007-assistant-style-tui-shell.md) | High | Drafted | 004, 005, 006 |
| 008 | Arbitrary project targeting | V2 | `docs/prd/008-arbitrary-project-targeting.md` | Medium | Later | 004, 006, 007 |
| 009 | Git URL import into managed source directory | V2 | `docs/prd/009-git-url-import-into-managed-source-directory.md` | Medium | Later | 003, 006 |
| 010 | Manual install migration | V2 | `docs/prd/010-manual-install-migration.md` | Medium | Later | 004, 006 |
| 011 | Stronger TUI exposure editing | V2 | `docs/prd/011-stronger-tui-exposure-editing.md` | Medium | Later | 006, 007 |
| 012 | Context budget visibility | V3 | `docs/prd/012-context-budget-visibility.md` | Low | Parking lot | 004, 007 |
| 013 | Shareable setup profiles | V3 | `docs/prd/013-shareable-setup-profiles.md` | Low | Parking lot | 008, 009, 010 |
| 014 | Repository health and update awareness | V3 | `docs/prd/014-repository-health-and-update-awareness.md` | Low | Parking lot | 009 |
